...
const Recommendations = () => {
  ...
  return (
    ...
    <div className=' p-6  mt-12 
     md:w-[90%]'> 
      <h3 className='text-[#313178]' style={{ fontFamily: 
        "'Madimi One',sans-serif", fontWeight: 400, fontStyle: 
        'normal', fontSize:"40px"}}> Recommendations</h3>
        <div className='grid md:grid-cols-3 gap-2'>
        {Data?.tasks?.map((task) => (
          <div key={task.username} className='border-2   my-2 p-3   rounded-[10px]'>
        ...
        px-4 rounded"
        onClick={handler_route}> give recommendations</button>
